    ...
    <div className={`navbar-navbar-container ${props.rootClassName} `}>
      ...
      >
        <div className="navbar-container">
          <img
            alt={props.Subtract_alt1}
            src={props.Subtract_src1}
            className="navbar-subtract"
          />
        </div>
...
Navbar.defaultProps = {
  ...
  Subtract_alt: 'Subtract1420',
  image_src1: '/logo-1500h.png',
  image_alt: 'logo',
  Subtract_src:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/bea996e9-5715-46ea-96fb-8ecfea3d65e3/9b5e8733-3fb4-4c4a-93ba-0025d96efede?org_if_sml=1587',
  Subtract_alt2: 'Subtract1420',
  Subtract_src1: '/external/subtract1420-xnth.svg',
  rootClassName: '',
  Subtract_src2:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/bea996e9-5715-46ea-96fb-8ecfea3d65e3/4386008f-719b-4769-94b7-223dcd532820?org_if_sml=1587',
  image_alt1: 'image',
  Subtract_alt1: 'Subtract1420',
  text: 'Follow us',
...
Navbar.propTypes = {
  ...
  Subtract_alt: PropTypes.string,
  image_src1: PropTypes.string,
  image_alt: PropTypes.string,
  Subtract_src: PropTypes.string,
  Subtract_alt2: PropTypes.string,
  Subtract_src1: PropTypes.string,
  rootClassName: PropTypes.string,
  Subtract_src2: PropTypes.string,
  image_alt1: PropTypes.string,
  Subtract_alt1: PropTypes.string,
